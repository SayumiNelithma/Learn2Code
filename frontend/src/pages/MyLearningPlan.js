...
export default function MyLearningPlans() {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, minHeight: '100vh', bgcolor: '#f5f9fc' }}>
      <Leftsidebar />
        ...
        <Container maxWidth="lg">
          ...
          {loading ? (
            ...
            >
              ...
              <Typography variant="h5" gutterBottom>No Learning Plans Yet</Typography>
                  ...
                  <Grid item xs={12} sm={6} md={4} key={plan.id}>
                    ...
                    >
                      ...
                      <CardContent sx={{ p: 3, flexGrow: 1 }}>
                        ...
                        <Typography variant="body2" color="text.secondary">
                          <strong>Target Date:</strong> {new Date(plan.targetDate).toLocaleDateString()}
                        </Typography>
              ...
              {editForm && (
                <Box sx={{ pt: 2 }}>
                  ...
                  <FormControl fullWidth margin="normal" sx={{ mb: 2 }}>
                    <InputLabel id="progress-label" sx={{ "&.Mui-focused": { color: "#2196f3" } }}>
                      Progress Status
                    </InputLabel>
                    <Select
